...
- Distributor provisioning: `POST /api/v1/tenants/provision` (HMAC server-to-server; see DEPLOYMENT.md)
...
- Set `TENANT_HMAC_SECRET` for Webfinance distributor provisioning
